...
exports.metrics = {
  //John's DIY Playground Example
  LIGHT_LEVEL : { name:'Light Level', regexp:/9905\:([\d\.]+)/i, value:'', unit:' level', },
  LED_OFF : { name:'LED Status', regexp:/9900\:0/i, value:'OFF', unit:'', },
  LED_ON : { name:'LED Status', regexp:/9900\:1/i, value:'ON', unit:'', },
...
exports.motes = {
  JohnsDIYexample : {
    label   : 'Johns DIY Example',
    icon : 'icon_doorbell.png',
    controls : { toggleLED : { states: [{ label:'Turn LED on!', action:'LON', icon:'arrow-u', css:'background-color:#FF9B9B;',condition:''+function(node) { return node.metrics['LED Status']!=null && node.metrics['LED Status'].value == 'OFF'; } },
                                        { label:'Turn LED off!', action:'LOF', icon:'arrow-d', css:'background-color:#9BFFBE;color:#000000',condition:''+function(node) { return node.metrics['LED Status'].value == 'ON'; } }],
                             },
               },
  },
